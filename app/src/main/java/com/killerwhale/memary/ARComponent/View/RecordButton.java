...
//import com.killerwhale.memary.AnalyticsEvents;
//import com.killerwhale.memary.Fa;
...
public class RecordButton extends FrameLayout {
    ...
    public boolean performClick() {
        ...
        switch (mRecordingState) {
            ...
            case RECORDING:
                ...
                setContentDescription(getContext().getString(R.string.content_description_draw));
    ...
    public void setRecording(boolean recording) {
        if (recording) {
            ...
            setContentDescription(getContext().getString(R.string.content_description_upload));
        } else {
