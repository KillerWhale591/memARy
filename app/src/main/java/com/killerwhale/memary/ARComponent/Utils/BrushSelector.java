...
public class BrushSelector extends ConstraintLayout implements View.OnClickListener {
    ...
    private static final Pair<Integer, ARSettings.LineWidth> defaultBrush = new Pair<>(MEDIUM_BRUSH,
            ARSettings.LineWidth.MEDIUM);
    ...
    private ARSettings.LineWidth mSelectedLineWidth = defaultBrush.second;
        ...
        mBrushButton.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    ARSettings.LineWidth lineWidth;
                    ...
                    if (mSmallButtonLoc[1] < yloc && yloc < (mSmallButtonLoc[1] + mSmallButton
                        ...
                        if (mSelectedBrush != SMALL_BRUSH) {
                            lineWidth = ARSettings.LineWidth.SMALL;
    ...
    public void onClick(View view) {
        ...
        ARSettings.LineWidth lineWidth = null;
        switch (view.getId()) {
    ...
    private void onBrushSizeSelected(ARSettings.LineWidth lineWidth) {
    ...
    public ARSettings.LineWidth getSelectedLineWidth() {
